...
const headers = ["SKU", "Product", "Quantity On Hand", "Reorder Point", "Reorder Quantity"];
const cells = ["sku", "name", "quantity_on_hand", "reorder_point", "reorder_quantity"];
...
export default function ReportPage() {
  ...
  useEffect(() => {
    fetchApiRows<ReportRow>('/api/admin/reports/inventory?tenant_slug=demo-company')
      .then(setRows)
  ...
  return (
    <main className="main">
      <h1>Inventory Reorder Report</h1>
