...
const api = '/api/customer/history?tenant_slug=demo-company';
const headers = ["Work Order", "Status", "Summary", "Completed"];
const cells = ["work_order_number", "status", "summary", "completed_at"];
