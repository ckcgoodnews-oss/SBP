...
const api = '/api/customer/invoices?tenant_slug=demo-company';
const headers = ["Invoice", "Status", "Total", "Paid"];
const cells = ["invoice_number", "status", "total_amount", "amount_paid"];
