...
const api = '/api/technician/jobs?tenant_slug=demo-company';
const headers = ["Work Order", "Status", "Priority", "Summary"];
const cells = ["work_order_number", "status", "priority", "summary"];
