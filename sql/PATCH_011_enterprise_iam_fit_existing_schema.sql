-- PATCH_011 / Enterprise IAM fitted to the actual SBP schema
-- Use this AFTER PATCH_009 succeeded. Do NOT run PATCH_010 again.
-- This patch uses the real tenant schema:
--   tenants, tenant_users, iam_roles, iam_permissions, iam_role_permissions,
--   tenant_user_role_assignments, iam_sessions, api_keys, service_accounts,
--   user_location_permissions, service_locations, warehouses.
-- It intentionally does NOT create/use app_users, users, profiles, or iam_sessions.user_id.
...
-- -----------------------------------------------------------------------------
select 'PATCH_011_ENTERPRISE_IAM_EXISTING_SCHEMA_OK' as status;
